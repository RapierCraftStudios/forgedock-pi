...
- `RESULT.md`: scope, original cause, model outcome, setup failures, validation status, and explicit runtime-qualification boundary.
...
- `model-exercise.json`: exact disposable PR identity, model-exercise runtime versus intended installation runtime, deadlines, native role/run/report identities, recovery result, adjudication/gate, and controlled-transport counts.
