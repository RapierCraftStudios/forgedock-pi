...
- every GitHub mutation revalidates the current run/lease authority;
- protected branches are not auto-merged;
- required checks, reviewers, audit artifacts, exact PR head/base identity, and leases fail closed.
